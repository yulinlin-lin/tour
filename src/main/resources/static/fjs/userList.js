layui.use(['form', 'layer', 'laydate', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'userRealName', title: '真正姓名', align: "center"},
            {field: 'password', title: '密码', align: 'center'},
            {field: 'phone', title: '电话', align: 'center'},
            {field: 'sex', title: '性别', align: 'center'},
            {field: 'imgFileName', title: '图片名字', align: 'center',templet: function (d) {
                    return "<span id=\"photo-list_" + d.userId + "\"><img onclick='showSceneryPic(this);' src=\"" + base + d.imgFileName + "\" alt='我是头像啊！' style=\"width: 40px;\" lay-event=\"showPic\" ></span>";
                }},
